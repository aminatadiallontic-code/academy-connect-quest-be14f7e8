...
import { GraduationCap, Mail, Lock, Eye, EyeOff, Phone, User, ArrowLeft, Sparkles, CheckCircle2 } from "lucide-react";
      ...
      <div className="hidden gradient-hero lg:flex lg:w-1/2 lg:flex-col lg:items-center lg:justify-center lg:p-12 relative overflow-hidden">
        ...
        >
          ...
          <div className="mt-10 space-y-3">
            {["Inscription gratuite", "Données sécurisées", "Support réactif"].map((text, i) => (
              <motion.div
                key={text}
      ...
      <div className="flex w-full items-center justify-center p-6 lg:w-1/2 bg-background">
        ...
        >
          ...
          <div className="mb-1 inline-flex items-center gap-1.5 text-sm text-accent font-medium">
            <Sparkles className="h-3.5 w-3.5" /> Rejoignez-nous
          </div>
          <h2 className="font-display text-2xl sm:text-3xl font-bold text-foreground tracking-tight">Inscription</h2>
          <p className="mt-2 text-muted-foreground">Créez votre compte gratuitement</p>
          ...
          <Button
            ...
            className="w-full h-11 rounded-xl border-border/80 bg-card hover:bg-muted/40 font-medium gap-2"
          >
