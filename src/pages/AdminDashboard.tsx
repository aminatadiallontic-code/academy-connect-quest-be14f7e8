...
const AdminDashboard = () => {
  ...
  const handleExportPdf = (student: Student) => {
    ...
    exportStudentPdf({
      ...
      birthDate: "", birthPlace: "", gender: "", nationality: "",
      address: "", phone: "", email: student.email, educationLevel: "",
      studentId: student.id, institution: "", program: student.program,
      birthCertNumber: "", guardianName: "", guardianPhone: "",
      status: student.status, submittedAt: student.submittedAt,
    });
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-6 sm:py-8 max-w-6xl">
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
          <h1 className="font-display text-xl sm:text-2xl font-bold text-foreground tracking-tight mb-6">
                ...
                return (
                  <div key={student.id} className="p-4 space-y-3">
                    ...
                    <div className="flex gap-2">
                      ...
                      <Button variant="outline" size="sm" className="rounded-xl" onClick={() => handleExportPdf(student)}>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-border/60 text-left text-xs text-muted-foreground">
                    ...
                    <th className="px-5 py-3.5 font-medium hidden md:table-cell">Soumis le</th>
                  ...
                  {filtered.map((student) => {
                    ...
                    return (
                      <tr key={student.id} className="border-b border-border/40 last:border-0 hover:bg-muted/30 transition-colors">
                        ...
                        <td className="px-5 py-4 hidden md:table-cell text-muted-foreground">{student.submittedAt}</td>
                        <td className="px-5 py-4">
            ...
            <div className="space-y-4 pt-2">
              <div className="rounded-xl bg-muted/40 p-4 space-y-3">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Badge variant="secondary" className={`${statusMap[selected.status].className} rounded-lg`}>
              ...
              <div className="flex gap-2 pt-1">
                <Button
                  className="flex-1 rounded-xl gradient-accent text-accent-foreground btn-shine"
